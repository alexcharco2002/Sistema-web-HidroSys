        ...
        <div className="modal-overlay">
          <div className="modal">
            <div className="modal-header">
              <h3><Eye className="w-5 h-5 inline mr-2" />Detalle de Lectura</h3>
            ...
            <div className="modal-body">
              <div className="user-details">
                ...
                <div className="detail-group"><label>Medidor:</label><p>{selectedLectura.medidor?.num_medidor || 'N/A'}</p></div>
                <div className="detail-group"><label>Sector:</label><p>{selectedLectura.sector || 'Sin sector'}</p></div>
                <div className="detail-group"><label>Código de Afiliado:</label><p>{selectedLectura.codigo_afiliado || 'N/A'}</p></div>
                <div className="detail-group"><label>Nombre Afiliado:</label><p>{selectedLectura.nombre_afiliado || 'Sin afiliado'}</p></div>
                <div className="detail-group"><label>Lectura Anterior:</label><p>{selectedLectura.lectura_anterior} m³</p></div>
                <div className="detail-group"><label>Lectura Actual:</label><p>{selectedLectura.lectura_actual} m³</p></div>
                <div className="detail-group"><label>Consumo:</label><p className="text-blue-600 font-semibold text-xl">{selectedLectura.consumo_m3} m³</p></div>
                <div className="detail-group"><label>Fecha lectura:</label><p>{formatDate(selectedLectura.fecha_lectura)}</p></div>
                <div className="detail-group">
                  <label>Tipo de Lectura:</label>
                  <div>
                    {selectedLectura.es_estimada ? (
                      <div className="lectura-badge lectura-badge-estimada"><AlertCircle className="w-3 h-3" /><span>Estimada</span></div>
                    ) : (
                      <div className="lectura-badge lectura-badge-real"><Activity className="w-3 h-3" /><span>Real</span></div>
                    )}
                  </div>
                </div>
                <div className="detail-group">
